...
from models.GSRefiner.utils.graphics import getWorld2View2, focal2fov, fov2focal
from models.GSRefiner.utils.graphics import getProjectionMatrix
from models.GSRefiner.utils.trajectory import get_camerapaths
from models.GSRefiner.utils.sh import SH2RGB
...
def readDataInfo(traindata, white_background):
    ...
    render_cameras = [camera for index, camera in enumerate(train_cameras)]
